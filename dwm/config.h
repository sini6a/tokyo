...
static const char *fonts[]               = { "JetBrainsMono Nerd Font:size=10:style=bold:antialias=true:autohint=true", "Noto Sans Mono CJK HK:size=7:style=bold:antialias=true:autohint=true" };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_d,          spawn,                  SHCMD("~/.config/rofi/launchers/greenclip/launcher.sh")}, /* greenclip launcher */
	{ MODKEY,		                XK_space,      spawn,                  SHCMD("xkb-switch -n")}, /* cycle through keyboard layouts */
